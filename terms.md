...
Paloma Parties facilitates interactions between event hosts/planners and vendors/venues. Our platform includes automated response systems that assist with inquiries and information. We are deeply committed to providing the highest level of accuracy possible and continuously work to ensure our service behaves according to our customers' intentions. However, while venues configure their own responses and information, automated responses may deviate from intended configurations. Users should and are encouraged to verify all information directly with venues, and venues are responsible for monitoring and reporting any discrepancies in their automated responses. No warranties or guarantees are offered regarding the accuracy of automated responses, even when properly configured by venues.
...
For legal notices or inquiries, please contact us at [contact@palomaparties.com](mailto:contact@palomaparties.com).
